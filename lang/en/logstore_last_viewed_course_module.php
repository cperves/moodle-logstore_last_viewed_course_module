...
$string['pluginname'] = 'last viewed course module log store';
$string['privacy:metadata:log'] = 'A collection of course module past view events';
...
$string['privacy:metadata:log:lasttimeviewed'] = 'The time when user last view this course module';
